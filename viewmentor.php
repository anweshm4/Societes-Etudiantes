<!DOCTYPE html>
	...
	<?php
    	...
    	echo "<p class='clubheader'> Mentor Report <hr class='clubhr'> </p> </div>";
	...
	if (mysqli_num_rows($result) > 0)
	{
    	...
    	echo "<br><br><br><br><table class='data'><thead> <tr><th> Name </th> <th> Email ID </th> <th> Club Name </th><th> Update </th> <th> Delete </th> </tr> </thead> <br><br>";
