<!DOCTYPE html>
	...
	<?php
    	...
    	$sql="SELECT m.clubid FROM mentor m JOIN user u WHERE u.email = m.emailid AND username LIKE '$username'";
	...
	if (mysqli_num_rows($result) > 0)
	{
    	...
    	{	
        	...
        	<td>". $row['AGP']."</td>
        	<td>". $row['CCGP']."</td>
        	<td> <a href='mentorappointpresident.php?id=".$row['registerno']."'>Appoint President </a> </td>
        	 </tr>";
	  	}
