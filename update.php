<!DOCTYPE html>
	...
	<?php
		...
		?>
		<form name="update" method="POST" action="updated.php">
		<?php

		if (mysqli_num_rows($result) > 0)
		{
    		// output data of each row
    		echo "<table border='1' cellpadding='5' cellspacing='5' width='90%'> <tr><th> Register Number </th> <th> Name </th> <th> Club ID </th> <th> Email ID </th> <th> Joining Date </th> <th> AGP </th> <th> CCGP </th> <th> Action </th></tr>";
